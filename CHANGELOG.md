...
- **CSS: `.list-group-header` (visual list) + `.list-group-header-row` / `.list-group-header-cell` (table)** added to `src/core/css/list-view.css`. Token-based — dark theme automatic.
