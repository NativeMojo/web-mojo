/**
 * Deprecated: Legacy RegisterPage has been removed.
 *
 * The old auth pages (RegisterPage, LoginPage, Forgot/Reset) are no longer used.
...
const DEPRECATION_MESSAGE =
  'RegisterPage is removed. Use mountAuth() or createAuthClient() from "web-mojo/auth".';
