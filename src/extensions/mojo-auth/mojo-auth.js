...
(function (root, factory) {
    ...
    var MojoAuth = {
        ...
        login: function (username, password) {
            return post(ep('login'), { username: username, password: password })
                .then(function (resp) {
        ...
        forgotPasswordCode: function (email) {
            return post(ep('forgotPassword'), { email: email, method: 'code' });
        },
        ...
        forgotPasswordLink: function (email) {
            return post(ep('forgotPassword'), { email: email, method: 'link' });
        },
        ...
        sendMagicLink: function (email) {
            return post(ep('magicSend'), { email: email });
        },
        ...
        loginWithMagicToken: function (token) {
            return post(ep('magicLogin'), { token: token }).then(saveTokens);
        },
