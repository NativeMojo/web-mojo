...
User.GRANULAR_PERMISSION_TABS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            { name: "manage_webapp", label: "Manage WebApps",
              tooltip: "Link site CI keys and promote or roll back verified WebApp releases; site read/write authority is also required." },
            { name: "manage_deploy", label: "Manage Fleet Deploys",
              tooltip: "Globally queue an exact Git revision across the Edge fleet. Member and API-key grants do not qualify." },
