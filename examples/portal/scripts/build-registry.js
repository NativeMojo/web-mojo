        ...
        groups: [
            ...
            },
            {
                ...
                items: [
                    ...
                    'components/list-view/grouped',
                    'components/list-view/row-stripe',
                    'components/table-view',
                    'components/table-view/columns',
                    'components/table-view/toolbar',
                    'components/table-view/context-menu',
                    'components/table-view/inline-edit',
        ...
        groups: [
            ...
            },
            {
                ...
                items: [
                    ...
                    'forms/inputs/time-picker',
                    'forms/inputs/date-time-picker',
