...
| [Date & Time Suite](../../examples/portal/examples/forms/inputs/DateTimeSuite/DateTimeSuiteExample.js) | Full DatePicker / DateRangePicker showcase — day/month/year precision, ranges, presets, constraints, inline, custom formats. | [forms/inputs/DatePicker.md](../../docs/web-mojo/forms/inputs/DatePicker.md) |
