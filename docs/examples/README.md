...
- ✅ Modern href-based navigation with copy-link support
- ✅ Enhanced data-page routing with parameters  
...
- Modern navigation patterns with href and data-page
- SEO-friendly routing with copy-link support
...
- **href-based Navigation** - SEO-friendly links with copy-link support
- **Enhanced Routing** - data-page navigation with parameter passing
...
### Navigation System
```html
<!-- Standard href Navigation (Primary) -->
<a href="/">Home</a>
...
<button data-page="user" data-params='{"id": 123, "tab": "profile"}'>View Profile</button>
...
**4. Navigation Issues**
- Use proper `href` attributes for SEO-friendly navigation
- Add `data-external` for external links to prevent interception
- Ensure router is globally accessible: `window.MOJO.router`
