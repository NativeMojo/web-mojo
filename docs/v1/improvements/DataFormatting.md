...
relative(value, options)  // "2 hours ago"
...
```javascript
// test/utils/DataFormatter.test.js
...
This implementation will significantly improve data presentation capabilities across MOJO applications while maintaining the framework's core principles of simplicity and convention over configuration.
```

This design document provides a comprehensive plan for implementing the DataFormatter utility with:

1. **Clean API** - No "format" prefix, just simple function names
2. **Pipe Support** - Full pipe syntax with argument passing
3. **Model Integration** - Model.get() with pipe support
4. **Table Integration** - Flexible formatter configuration (string, function, object, pipe)
5. **Mustache Integration** - Template pipe syntax support
6. **Extensibility** - Easy custom formatter registration
7. **Context-Aware** - Formatters receive appropriate context
8. **Error Handling** - Graceful degradation
9. **Testing Strategy** - Comprehensive test coverage
10. **Migration Path** - Phased implementation approach

The design follows MOJO principles of simplicity, convention over configuration, and developer experience. Would you like me to create this file in the docs/improvements folder or would you like to refine any aspects of the design?
